...
def gpt4o_query(file_path, prompt, max_retries=5, initial_delay=3):
...
def main():
    ...
    video_root = "/data/wangxd/LLaVA-Video-178K/2_3_m_youtube_v0_1/liwei_youtube_videos/videos/youtube_video_2024"
    jsonl_file = "/data/wangxd/LLaVA-Video-178K/2_3_m_youtube_v0_1/2_3_m_youtube_mc_v0_1_qa_processed.json"
