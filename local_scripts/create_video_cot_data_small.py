...
def main():
    ...
    video_root = "/data/wangxd/LLaVA-Video-small-swift/"
    jsonl_file = "/data/wangxd/LLaVA-Video-small-swift/train.jsonl"
    ...
    answers_file = os.path.join("/home/user/wangxd/open-r1-multimodal/data", f"LLaVA-Video-small-swift-gemini-1.5-pro.jsonl")
    ans_file = open(answers_file, "w")
    
    for item in tqdm(jsonl_data[::-1]):
