...
def main():
    ...
    video_root = "/data/wangxd/LLaVA-Video-medium-swift/"
    jsonl_file = "/data/wangxd/LLaVA-Video-medium-swift/train.jsonl"
    ...
    answers_file = os.path.join("/home/user/wangxd/open-r1-multimodal/data", f"LLaVA-Video-medium-swift-gemini-1.5-pro.jsonl")
